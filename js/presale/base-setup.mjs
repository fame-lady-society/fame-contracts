...
const MNEMONIC = process.env.BASE_MNEMONIC;
const FAME_SALE_CONTRACT_ADDRESS = process.env.BASE_FAME_SALE;
const safeAddress = process.env.BASE_MULTISIG_ADDRESS;
